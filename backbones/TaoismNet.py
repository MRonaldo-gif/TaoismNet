...
__all__ = ['TaoismNet_5', 'TaoismNet_6', 'TaoismNet_7', 'TaoismNet_8', 'TaoismNet_9', 'TaoismNet_10',
           'TaoismNet_11', 'TaoismNet_12', 'TaoismNet_13', 'TaoismNet_13_x1_5', 'TaoismNet_13_x1_5_ada_pool']
...
class TaoismNet(BaseModule):
    def __init__(self, in_chans=3, num_classes=1000,
                 # dims=[96, 192, 384, 768],
                 # strides=[2, 2, 2, 1],
                 dims=[128 * 4, 256 * 4, 512 * 4, 1024 * 4, 1024 * 4],
                 strides=[2, 2, 2, 1],
                 drop_rate=0, act_num=3,  deploy=False, ada_pool=None, **kwargs):
        super().__init__()
        self.deploy = deploy
        if self.deploy:
...
def TaoismNet_5(pretrained='', in_22k=False, **kwargs):
    model = TaoismNet(dims=[128 * 4, 256 * 4, 512 * 4, 1024 * 4], strides=[2, 2, 2], **kwargs)
    if pretrained:
...
def TaoismNet_6(pretrained='', in_22k=False, **kwargs):
    model = TaoismNet(dims=[128 * 4, 256 * 4, 512 * 4, 1024 * 4, 1024 * 4],
                       strides=[2, 2, 2, 1], **kwargs)
    if pretrained:
        weights = torch.load(pretrained)['model_ema']
        model.load_state_dict(update_weight(model.state_dict(), weights))
    return model
...
def TaoismNet_7(pretrained='', in_22k=False, **kwargs):
    model = TaoismNet(dims=[128 * 4, 128 * 4, 256 * 4, 512 * 4, 1024 * 4, 1024 * 4],
                       strides=[1, 2, 2, 2, 1], **kwargs)
    if pretrained:
        weights = torch.load(pretrained)['model_ema']
        model.load_state_dict(update_weight(model.state_dict(), weights))
    return model
...
def TaoismNet_8(pretrained='', in_22k=False, **kwargs):
    model = TaoismNet(dims=[128 * 4, 128 * 4, 256 * 4, 512 * 4, 512 * 4, 1024 * 4, 1024 * 4],
...
def TaoismNet_9(pretrained='', in_22k=False, **kwargs):
    model = TaoismNet(dims=[128 * 4, 128 * 4, 256 * 4, 512 * 4, 512 * 4, 512 * 4, 1024 * 4, 1024 * 4],
...
def TaoismNet_10(pretrained='', in_22k=False, **kwargs):
    model = TaoismNet(
...
def TaoismNet_11(pretrained='', in_22k=False, **kwargs):
    model = TaoismNet(
...
def TaoismNet_12(pretrained='', in_22k=False, **kwargs):
    model = TaoismNet(
...
def TaoismNet_13(pretrained='', in_22k=False, **kwargs):
    model = TaoismNet(
...
def TaoismNet_13_x1_5(pretrained='', in_22k=False, **kwargs):
    model = TaoismNet(
...
def TaoismNet_13_x1_5_ada_pool(pretrained='', in_22k=False, **kwargs):
    model = TaoismNet(
        dims=[128 * 6, 128 * 6, 256 * 6, 512 * 6, 512 * 6, 512 * 6, 512 * 6, 512 * 6, 512 * 6, 512 * 6, 1024 * 6,
              1024 * 6],
        strides=[1, 2, 2, 1, 1, 1, 1, 1, 1, 2, 1],
